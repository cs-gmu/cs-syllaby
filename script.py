...
mkdocs_file_path = os.path.join(current_directory, 'docs/spring_2025.md')
syllabi_folder_path = os.path.join(current_directory, 'Syllabi')  # Path to the Syllabi folder
